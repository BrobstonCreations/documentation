...
- 1x - Microwave bezel bracket
- 1x - Microwave shelf bracket
- 1x - Induction cooktop spacer
- 1x - Induction cooktop mount brackets
- 1x - (if purchased) Large Kitchen Galley rear vent bracket
...
- 2x - locking machine nuts (for macerator switch)
- 4x - washers (for macerator switch)
- Rubber with adhesive backing

### Not included in the kit:
- 1x - [Microwave](https://www.walmart.com/ip/Mainstays-0-7-Cu-ft-Countertop-Microwave-Oven-700-Watts-Black-New/5125973778)
- 1x - 120v 20amp outlet
- 1x - Single gang electrical box
...
7. In order to gain as much space as possible between the induction cooktop and the microwave, I would recommend replacing the two 1/2 inch boards under the fridge with one 3/4 inch board, which lowers the fridge by 1/4 inch. This allows you to  mount the microwave shelf 1/4 inch lower, which gains you 1/4 inch of space between the microwave and the induction cooktop for better airflow to cool the cooktop. This should also maintain about 1/8 inch gap between the bottom front of the fridge and the floor (for me this was needed for my Inhabit Design floor mat). You can take the previous board and use that to mark on a new board to cut it out to the same size. I did this with a circular saw, but you could use a jigsaw or other cutting tool. Though I haven't tested this personally, one customer (Fred Trimble) used two sections of board; one on the left and one on the right, which leaves an opening in the middle for additional airflow. [Picture here](2018-2020-Winnebago-Revel-Kitchen-Galley-Microwave-Install-Instructions-images/537d422c-917a-4f5f-a5a1-f684bb7f2fd9.jpeg)
...
8. You will need to cut an opening for the microwave. (See picture from the next step) In general I recommend first marking a line for the opening and then conservatively remove material. You can always remove more material, but you can't add it back. You can always cut near the line and then later use a palm sander to remove more material where needed. The most efficient use of space will result in the bottom front of the microwave shelf touching the top of the fridge when the fridge is installed. The rest of the shelf will then be squared to the front of the kitchen galley. The easiest way to tell if you have accomplished this is to check how far the microwave is sticking out from the front of the kitchen galley on the left, top, and right of the microwave; the stick-out distance should be consistent on these three sides. I recommend making your left cut against the inner vertical brace to the left of the fridge and do the same on the right. If you did step 7 the top cut will be `1 9/16 in` (`39.68 mm`) below the bottom of the countertop (and if you did NOT do step 7 the top cut will be `1 5/16 in` (`33.5 mm`) below the bottom of the countertop). Note, for the latest version of the microwave bezel, we have added one row of venting above the microwave, you will need to cut higher to take advantage of this venting. You can either cut the opening for the microwave body, then put the bezel in place and mark the additional vent, then remove the bezel, and cut the additional section; or you can decrease the previous distance given by `3/8 in` (`10mm`). You will also need to remove the majority of the front right inner brace. The bumpout on the right side of the microwave near the front ends up in this space.
...
16. On the under side of the shelf, use the slots on the mounting face of the shelf so that you can temporary mount the shelf, allowing you to test fit the fridge. The shelf is mounted using the self tapping countersunk head screws. Align the screws so that they do not miss the support that they are screwing into.
...
27. This step is optional. I have pretty thoroughly tested installing the microwave without straps. Assuming the microwave shelf is far enough forward to prevent the microwave from being able to be pushed back and the microwave bezel is tight around the microwave, I have not seen the microwave move at all. The upside to not using straps is slightly better ventilation. If you would still prefer to install straps they can be ordered on Amazon (https://www.amazon.com/dp/B0BKVKY1L3). Install the microwave shelf straps and microwave. The next few pictures show how to manage the microwave and the straps; it is somewhat tricky to get the straps around the microwave and this is the easiest approach I have found.
...
28. If you are happy with the stick-out of the microwave from the front face of the kitchen galley, go ahead and finalize the mounting of the microwave shelf. On the mounting points of the shelf that are slots and holes, screw in the self tapping countersunk head screws into the holes to lock the microwave shelf into place.

29. Mark the microwave bezel mounting hole locations.
...
30. Remove the microwave and drill pilot holes for the microwave bezel mounting holes. Use a drill bit that is equal to or slightly smaller than the diameter of the screw shank (not the threads). (Do not install the fridge yet, disregard the fridge in the image)
...
31. Install the macerator switch (using the two machine cap head screws, four washers, and two lock nuts) into the microwave bezel, attach the macerator switch wiring, install the microwave bezel.
![46-install-bezel.jpg](2018-2020-Winnebago-Revel-Kitchen-Galley-Microwave-Install-Instructions-images/46-install-bezel.jpg)

32. Reinstall the fridge. Reconnect the fridge wiring, reinstall the screws/caps, and install the fridge door.
